    ...
    MuiPaper: {
      ...
      styleOverrides: {
        root: {
          ...
          boxShadow: '0px 12px 40px rgba(0, 0, 0, 0.08), 0px 4px 10px rgba(0, 0, 0, 0.04), inset 0px 1px 0px rgba(255, 255, 255, 0.8)',
        },
      },
    },
    MuiCard: {
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            boxShadow: '0px 20px 50px rgba(0, 0, 0, 0.12), 0px 8px 16px rgba(0, 0, 0, 0.06), inset 0px 1px 0px rgba(255, 255, 255, 1)',
